...
@Slf4j
@Component
public class ChatTtsBiz implements IChatTtsBiz {

    private final IChatService chatService;
    private final ITtsService ttsService;

    @Autowired
    public ChatTtsBiz(IChatService chatService, @Qualifier("customTtsServiceImpl") ITtsService ttsService) {
    ...
    public Flux<String> chatStreamWithVoice(String prompt) {
        ...
        // 将文本流转换为语音流并播放
        ttsService.playTextStream(responseFlux);
        return responseFlux;
    }
    ...
    public void chatSSEWithVoice(ChatRequestDTO chatRequestDTO) {
        ...
        // 将文本流转换为语音流并播放
        ttsService.playTextStream(textFlux);
